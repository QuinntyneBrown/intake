...
export class QuestionMasterDetailEmbedComponent extends HTMLElement {
    constructor(
        private _questionService: QuestionService = QuestionService,
    ...
    private async _bind() {
        ...
        const surveys = await this._surveyService.get();
...
customElements.define(`ce-question-master-detail`,QuestionMasterDetailEmbedComponent);
